<?php include 'includes/header.php'; ?>
    ...
    <div class="grid-container-text">
        <div class="text">
            <p>Základní deska je základním stavebním kamenem osobního počítače, její vlastnosti určují do značné míry vlastnosti celého počítače. Základní deska (také mateřská deska nebo motherboard) plní v počítači mnoho úkolů.
            </p><br>
